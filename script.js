...
// Pokemon Type1 dropdown type fetching
...
// Pokemon Type2 dropdown type fetching
    for (let r of data.results) {
        drop2 += `<option 
                value="${r.url}">${r.name}</option>`;
    }
...
//Type 1 Pokemons Fetching Code for results
...
// Type 2 Pokemons fetching code for results
